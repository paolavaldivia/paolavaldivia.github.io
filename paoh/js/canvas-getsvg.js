...
[
    ...
    var sName = s;
    CanvasSVG.Deferred.prototype.__defineGetter__(sName, function () {
        return this.context[sName];
    });
    ...
    CanvasSVG.Live.prototype.__defineGetter__(sName, function () {
        return this.context[sName];
    });
