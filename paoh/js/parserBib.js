...
var bib2json = function (bibfile) {
    ...
    dataArr = bibfile.toString().trim().splitKeep(/@[a-zA-Z]+ *{/g, 1);
    bigJson = [];
...
var display_data = function (json, error_text) {
    ...
    var display_all_views = function () {
        ...
        show_amount = AMOUNT({
            margin: {top: 157, right: 200, bottom: 0, left: 25},
            color_text: "#333333",
            //text_size: "70px",
            total: json.length,
            selected: "0",
    ...
    var remove_highlight_selection_items_types = function () {
        ...
        for (var i = 0; i < entryTypes_grouped_text.length; i++) {
            ...
            id_txt_label = generate_words_id({
                text: entryTypes_grouped_text[i],
                group: "type",
                element: "text"
            }).exist_id;
...
//                    actual_year = new Date().getFullYear();
                ...
                for (var x = 0; x < filter_criteria.years.length; x++) {
                    ...
                    for (var v = 0; v < filter_criteria.types.length; v++) {
                        ...
                        if (json[i].entryTags.year === filter_criteria.years[x]) {
                            ...
                            if (is_entry_type_of_catagory({
                                type: filter_criteria.types[v],
                    ...
                    for (var t = 0; t < filter_criteria.keywords.length; t++) {
                        ...
                        if ((json[i].entryTags.keywords !== undefined)
                            && (item_already_selected({
                                array: words_displayed,
                                key: "id",
                                value: filter_criteria.keywords[t]
                            }))) {

                            searched_word = lookup_wordtext({
                                array: words_displayed,
                                word_id: filter_criteria.keywords[t]
                            });
                            ...
                            if (n !== (-1)) {
                                ...
                                if ((json[i].entryTags.author !== undefined)
                                    && (item_already_selected({
                                        array: authors_displayed,
                                        key: "id",
                                        value: filter_criteria.authors[s]
                                    }))) {

                                    searched_word = lookup_wordtext({
                                        array: authors_displayed,
                                        word_id: filter_criteria.authors[s]
                                    });
            ...
            //years and authors are selected
                ...
                for (var p = 0; p < filter_criteria.years.length; p++) {
                    ...
                    for (var o = 0; o < filter_criteria.authors.length; o++) {
                        ...
                        searched_word = lookup_wordtext({
                            array: authors_displayed,
                            word_id: filter_criteria.authors[o]
                        });
            ...
            //types and keywords are selected
                ...
                for (var c = 0; c < filter_criteria.keywords.length; c++) {
                    ...
                    for (var d = 0; d < filter_criteria.types.length; d++) {
                        ...
                        if ((json[i].entryTags.keywords !== undefined)
                            && (item_already_selected({array: words_displayed, key: "text", value: searched_word}))
                            && (is_entry_type_of_catagory({
                                type: filter_criteria.types[d],
                                entryType: json[i].entryType
                            }))) {
            ...
            //types and authors are selected
                ...
                for (var q = 0; q < filter_criteria.authors.length; q++) {
                    ...
                    for (var r = 0; r < filter_criteria.types.length; r++) {
                        ...
                        searched_word = lookup_wordtext({
                            array: authors_displayed,
                            word_id: filter_criteria.authors[q]
                        });

                        if ((json[i].entryTags.author !== undefined)
                            && (item_already_selected({array: authors_displayed, key: "text", value: searched_word}))
                            && (is_entry_type_of_catagory({
                                type: filter_criteria.types[r],
                                entryType: json[i].entryType
                            }))) {
                ...
                for (var e = 0; e < filter_criteria.keywords.length; e++) {
                    ...
                    for (var f = 0; f < filter_criteria.years.length; f++) {
                        ...
                        for (var g = 0; g < filter_criteria.types.length; g++) {
                            ...
                            searched_word = lookup_wordtext({
                                array: words_displayed,
                                word_id: filter_criteria.keywords[g]
                            });
                        ...
                        for (var l = 0; l < filter_criteria.types.length; l++) {
                            ...
                            if ((json[i].entryTags.year === filter_criteria.years[h])
                                ...
                                && (item_already_selected({
                                    array: authors_displayed,
                                    key: "id",
                                    value: filter_criteria.authors[j]
                                }))
                                && (is_entry_type_of_catagory({
                                    type: filter_criteria.types[l],
                                    entryType: json[i].entryType
                                }))) {
                                ...
                                searched_word = lookup_wordtext({
                                    array: authors_displayed,
                                    word_id: filter_criteria.authors[j]
                                });
                        ...
                        for (var c = 0; c < filter_criteria.types.length; c++) {
                            ...
                            if ((is_entry_type_of_catagory({
                                ...
                                && (item_already_selected({
                                    array: words_displayed,
                                    key: "id",
                                    value: filter_criteria.keywords[b]
                                }))) {

                                searched_word = lookup_wordtext({
                                    array: words_displayed,
                                    word_id: filter_criteria.keywords[b]
                                });
                                ...
                                if (n !== (-1)) {
                                    ...
                                    if ((json[i].entryTags.author !== undefined)
                                        && (item_already_selected({
                                            array: authors_displayed,
                                            key: "id",
                                            value: filter_criteria.authors[a]
                                        }))) {

                                        searched_word = lookup_wordtext({
                                            array: authors_displayed,
                                            word_id: filter_criteria.authors[a]
                                        });
                            ...
                            if ((json[i].entryTags.year === filter_criteria.years[e])) {
                                ...
                                if ((json[i].entryTags.keywords !== undefined)
                                    && (item_already_selected({
                                        array: words_displayed,
                                        key: "id",
                                        value: filter_criteria.keywords[f]
                                    }))) {

                                    searched_word = lookup_wordtext({
                                        array: words_displayed,
                                        word_id: filter_criteria.keywords[f]
                                    });
                                    ...
                                    if (n !== (-1)) {
                                        ...
                                        if ((json[i].entryTags.author !== undefined)
                                            && (item_already_selected({
                                                array: authors_displayed,
                                                key: "id",
                                                value: filter_criteria.authors[g]
                                            }))) {

                                            searched_word = lookup_wordtext({
                                                array: authors_displayed,
                                                word_id: filter_criteria.authors[g]
                                            });
    ...
    var CHART = function () {
        ...
        var create_bar_chart = function (params) {
            ...
            chart.get_group = function () {
                return group
            };
            chart.get_groupH = function () {
                return groupH
            };
            chart.get_groupW = function () {
                return groupW
            };
            chart.get_oridinal_scale = function () {
                return oridinal_scale
            };
            chart.get_linear_scale = function () {
                return linear_scale
            };
            chart.get_margins = function () {
                return margin
            };
            chart.get_color_bar = function () {
                return color_bar
            };
            chart.get_color_text = function () {
                return color_text
            };
    ...
    var BAR_YEARS = function () {
        ...
        var create_bar_years = function (params) {
            ...
            new_bar_years.get_current_displayed_years = function () {
                return data_years
            };
            ...
            var create_bars = function () {
                ...
                bar = bar_group.selectAll("rect")
                    ...
                    .attr({
                        ...
                        y: function (d) {
                            return svgH - yScale(d) - label_space;
                        }, //subtract space for labels to have space for labels ;o)
            ...
            var create_tooltip = function () {
                ...
                tooltip_subset_height = get_width_of_text_element({
                    svg: svg,
                    group: bar_group,
                    data: data_amount
                }).height;
                ...
                var tooltips = bar_group.selectAll("text")
                    ...
                    .attr({
                        ...
                        y: function (d) {
                            return svgH - yScale(d) - label_space - tooltip_subset_height - distance_to_bar;
                        }, //3 space between bar and label
                        fill: "black",
                        opacity: 0,
                        "font-weight": "normal",
                        id: function (d, i) {
                            return "tooltip_normal_" + data_years[i];
                        },
                        "text-anchor": "end"
                    });
                ...
                var tooltips_subset = bar_highlight.selectAll("text")
                    ...
                    .attr({
                        ...
                        y: function (d) {
                            return svgH - yScale(d) - label_space - distance_to_bar;
                        }, //3 space between bar and label
                        fill: "black",
                        opacity: 0,
                        id: function (d, i) {
                            return "tooltip_subset_" + data_years[i];
                        },
                        "font-weight": "bold",
                        "text-anchor": "end"
                    })
            ...
            var update_tooltip = function (params) {
                ...
                var tooltips = bar_group.selectAll("text")
                    ...
                    .attr({
                        ...
                        opacity: 0,
                        id: function (d, i) {
                            return "tooltip_normal_" + dataset_years[i];
                        },
                        "font-weight": "normal",
                ...
                var tooltips_subset = bar_highlight.selectAll("text")
                    ...
                    .attr({
                        ...
                        opacity: 0,
                        id: function (d, i) {
                            return "tooltip_subset_" + dataset_years[i];
                        },
                        "font-weight": "bold",
            ...
            var create_bars_subset = function () {
                ...
                bar = bar_highlight.selectAll("rect")
                    ...
                    .attr({
                        ...
                        opacity: 0,
                        class: function (d, i) {
                            return "bar subset " + data_years[i];
                        },
                        id: function (d, i) {
            ...
            new_bar_years.highlight_subset = function (data_selected) {
                ...
                bar = bar_highlight.selectAll("rect")
                    ...
                    .attr({
                        ...
                        opacity: 1,
                        class: function (d, i) {
                            return "bar subset highlight " + data_years[i];
                        },
                        id: function (d, i) {
                            return "bar_subset" + data_years[i];
                        }
            ...
            var create_background_divs = function () {
                ...
                background_div = label_group.selectAll("rect")
                    ...
                    .attr({
                        x: function (d, i) {
                            return xScale(i) - ((label_width * overlap / 2))
                        },
                        y: 0 - label_height - 4,
                        id: function (d, i) {
                            return "background_div_" + d
                        },
            ...
            var create_buttons = function () {
                var btn_left, btn_right, btn_group, buttons_text = [], background_div, buttons, buttons_width,
                    buttons_height;
                ...
                background_div = btn_group.selectAll("rect")
                    ...
                    .attr({
                        x: function (d, i) {
                            return i * (svgW + 10)
                        }, //later to include the width of the button image
                        y: 0 - label_height - 4,
                        id: function (d, i) {
                            return d
                        },
        ...
        var create_bar_type = function (params) {
            ...
            var create_selection_divs = function () {
                var selection_div,
                    ...
                    selection_div = label_group.selectAll("rect")
                        ...
                        .attr({
                            y: function (d, i) {
                                return yScale(i) + label_height + (label_height / 2) * (-1)
                            },
                            x: function (d, i) {
                                return (d.length * 6 - distance_label_to_bars) * (-1)
                            },
                            id: function (d, i) {
                                if (d === "Part of a Book") {
            ...
            var create_labels = function () {
                ...
                labels = label_group.selectAll("text")
                    ...
                    .attr({
                        y: function (d, i) {
                            return yScale(i) + label_height + (label_height / 3)
                        },
